        ...
        <div className="glass-card shadow-glow-xl overflow-hidden border-none rounded-sm relative p-6 sm:p-8">
          ...
          <div className="relative z-10 space-y-6 sm:space-y-8">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-400 mb-6">{tImprint('lastUpdated')}</p>
            </div>
            ...
            <div className="prose prose-invert max-w-none">
              <div className="space-y-8 text-gray-300 leading-relaxed">
                ...
                <section>
                  <h2 className="text-2xl font-semibold text-white mb-4 text-center">{tImprint('organization.title')}</h2>
                  <div className="glass-card shadow-glow rounded-sm p-6 relative overflow-hidden">
                    <div className="absolute inset-0 animate-metallic-shine pointer-events-none rounded-sm"></div>
                    <div className="relative z-10">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          <p><strong>{tImprint('labels.name')}:</strong> {tImprint('organization.name')}</p>
                          <p><strong>{tImprint('labels.seat')}:</strong> {tImprint('organization.seat')}</p>
                          <p><strong>{tImprint('labels.address')}:</strong> {tImprint('organization.address')}</p>
                        </div>
                        <div>
                          <p><strong>{tImprint('labels.country')}:</strong> {tImprint('organization.country')}</p>
                          <p><strong>{tImprint('labels.foundationDate')}:</strong> {tImprint('organization.foundationDate')}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                {/* Partners */}
                <section>
                  <h2 className="text-2xl font-semibold text-white mb-4 text-center">{tImprint('partners.title')}</h2>
                  <div className="glass-card shadow-glow rounded-sm p-6 relative overflow-hidden">
                    <div className="absolute inset-0 animate-metallic-shine pointer-events-none rounded-sm"></div>
                    <div className="relative z-10">
                      <p>{tImprint('partners.partnersList')}</p>
                    </div>
                  </div>
                </section>
                ...
                <section>
                  <h2 className="text-2xl font-semibold text-white mb-4 text-center">{tImprint('registration.title')}</h2>
                  <div className="glass-card shadow-glow rounded-sm p-6 relative overflow-hidden">
                    <div className="absolute inset-0 animate-metallic-shine pointer-events-none rounded-sm"></div>
                    <div className="relative z-10">
                      <p className="mb-3">{tImprint('registration.authority')}</p>
                      <p><strong>{tImprint('registration.zvrNumber')}</strong></p>
                    </div>
                  </div>
                </section>
                ...
                {/* Contact Information */}
                <section>
                  <h2 className="text-2xl font-semibold text-white mb-4 text-center">{tImprint('contact.title')}</h2>
                  <div className="glass-card shadow-glow rounded-sm p-6 relative overflow-hidden">
                    <div className="absolute inset-0 animate-metallic-shine pointer-events-none rounded-sm"></div>
                    <div className="relative z-10">
                      <p className="mb-3"><strong>{tImprint('contact.emailLabel')}</strong> <a href="mailto:admin@queer-alliance.com" className="text-purple-300 hover:text-purple-200 underline">{tImprint('contact.email')}</a></p>
                      <p className="text-sm text-gray-400">{tImprint('contact.note')}</p>
                    </div>
                  </div>
                </section>
                ...
                <section>
                  <h2 className="text-2xl font-semibold text-white mb-4 text-center">{tImprint('responsible.title')}</h2>
                  <div className="glass-card shadow-glow rounded-sm p-6 relative overflow-hidden">
                    <div className="absolute inset-0 animate-metallic-shine pointer-events-none rounded-sm"></div>
                    <div className="relative z-10">
                      <p>{tImprint('responsible.content')}</p>
                    </div>
                  </div>
                </section>
                ...
                {/* Disclaimer */}
                <section>
                  <h2 className="text-2xl font-semibold text-white mb-4 text-center">{tImprint('disclaimer.title')}</h2>
                  <div className="glass-card shadow-glow rounded-sm p-6 relative overflow-hidden">
                    <div className="absolute inset-0 animate-metallic-shine pointer-events-none rounded-sm"></div>
                    <div className="relative z-10">
                      <p>{tImprint('disclaimer.content')}</p>
                    </div>
                  </div>
                </section>
